...
library(lubridate)
library(dplyr)
hr08 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.08.csv", header = TRUE, sep = ",")
hr09 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.09.csv", header = TRUE, sep = ",")
hr10 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.10.csv", header = TRUE, sep = ",")
hr11 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.11.csv", header = TRUE, sep = ",")
hr12 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.12.csv", header = TRUE, sep = ",")
hr13 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.13.csv", header = TRUE, sep = ",")
hr14 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.14.csv", header = TRUE, sep = ",")
hr15 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.15.csv", header = TRUE, sep = ",")
hr16 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.16.csv", header = TRUE, sep = ",")
hr17 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.17.csv", header = TRUE, sep = ",")
hr18 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.18.csv", header = TRUE, sep = ",")
hr19 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.19.csv", header = TRUE, sep = ",")
hr20 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.20.csv", header = TRUE, sep = ",")
hr21 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.21.csv", header = TRUE, sep = ",")
hr22 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.22.csv", header = TRUE, sep = ",")
hr23 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.23.csv", header = TRUE, sep = ",")
hr24 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.24.csv", header = TRUE, sep = ",")
hr25 <- read.csv("G:/My Drive/CodeProjs/FullStack Docs/BSB Savant Data/hrdata.25.csv", header = TRUE, sep = ",")
hrs <- bind_rows(hr08, hr09, hr10, hr11, hr12, hr13, hr14, hr15, hr16, hr17, hr18, hr19, hr20, hr21, hr22, hr23, hr24, hr25)
hrs2 = subset(hrs, select = -c(pitch_type, release_pos_x, zone, release_pos_z, batter, events, description, spin_dir, spin_rate_deprecated, break_angle_deprecated, break_length_deprecated, type, hit_location, pfx_x, pfx_z, plate_x, plate_z, hc_x, hc_y, tfs_deprecated, tfs_zulu_deprecated, umpire, sv_id, vx0, vy0, vz0, ax, ay, az, sz_top, intercept_ball_minus_batter_pos_y_inches, intercept_ball_minus_batter_pos_x_inches, swing_path_tilt, attack_direction, attack_angle, arm_angle, api_break_x_batter_in, api_break_x_arm, api_break_z_with_gravity, batter_days_until_next_game, pitcher_days_until_next_game, batter_days_since_prev_game, pitcher_days_since_prev_game, age_bat_legacy, age_pit_legacy, home_score_diff, hyper_speed, delta_pitcher_run_exp, estimated_slg_using_speedangle, swing_length, bat_speed, spin_axis, of_fielding_alignment, if_fielding_alignment, post_fld_score, post_bat_score, fld_score, bat_score, launch_speed_angle, iso_value, babip_value, woba_denom, woba_value, estimated_woba_using_speedangle, estimated_ba_using_speedangle, release_pos_y, fielder_9, fielder_8, fielder_7, fielder_6, fielder_5, fielder_4, fielder_3, fielder_2, game_pk, release_extension, release_spin_rate, effective_speed, launch_angle, launch_speed, hit_distance_sc, sz_bot))
